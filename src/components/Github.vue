<template>
  <div class="github-corner" title="Fork me on GitHub">
    <svg width="250" height="250" viewbox="0 0 250 250">
      <title>Fork me on GitHub</title>
      <path d="M0 0h250v250"></path>
      <path class="octo-arm" d="M127.4 110c-14.6-9.2-9.4-19.5-9.4-19.5 3-7 1.5-11 1.5-11-1-6.2 3-2 3-2 4 4.7 2 11 2 11-2.2 10.4 5 14.8 9 16.2"  fill="currentColor"></path>
      <a xlink:href="https://github.com/tfrere/colours-in-culture"
    target="_blank">
